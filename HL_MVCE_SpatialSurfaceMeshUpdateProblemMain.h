...
namespace HL_MVCE_SpatialSurfaceMeshUpdateProblem
{
    class HL_MVCE_SpatialSurfaceMeshUpdateProblemMain : public DX::IDeviceNotify
    {
    public:
        HL_MVCE_SpatialSurfaceMeshUpdateProblemMain(std::shared_ptr<DX::DeviceResources> const& deviceResources);
        ~HL_MVCE_SpatialSurfaceMeshUpdateProblemMain();
...
#pragma region SPATIAL MAPPING

        std::unique_ptr<SpatialMapping> m_mapping;
