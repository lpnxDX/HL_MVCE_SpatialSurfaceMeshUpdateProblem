...
HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::HL_MVCE_SpatialSurfaceMeshUpdateProblemMain(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded(bind(&HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnGamepadAdded, this, _1, _2));
    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved(bind(&HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnGamepadRemoved, this, _1, _2));
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged(bind(&HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2));
    }
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
    ...
    m_cameraAddedToken = m_holographicSpace.CameraAdded(std::bind(&HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnCameraAdded, this, _1, _2));
    ...
    m_cameraRemovedToken = m_holographicSpace.CameraRemoved(std::bind(&HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnCameraRemoved, this, _1, _2));
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::UnregisterHolographicEventHandlers()
{
...
HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::~HL_MVCE_SpatialSurfaceMeshUpdateProblemMain()
{
...
HolographicFrame HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::Update(HolographicFrame const& previousFrame)
{
    ...
    m_timer.Tick([this]()
    {
        ...
        if (m_mapping != nullptr) { // created line 597
            m_mapping->Update(m_stationaryReferenceFrame.CoordinateSystem());
        }
    });
...
bool HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::Render(HolographicFrame const& holographicFrame)
{
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::SaveAppState()
{
    //
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::LoadAppState()
{
    //
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnLocatabilityChanged(SpatialLocator const& sender, winrt::Windows::Foundation::IInspectable const& args)
{
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnCameraAdded(
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnCameraRemoved(
    HolographicSpace const& sender,
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnGamepadAdded(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnGamepadRemoved(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
concurrency::task<bool> CheckSpatialPerceptionAccessStatusAsync()
{
    using namespace winrt::Windows::Perception::Spatial::Surfaces;
    return concurrency::create_task([]
        {
            SpatialPerceptionAccessStatus status = SpatialSurfaceObserver::RequestAccessAsync().get();
            switch (status)
            {
...
void HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnHolographicDisplayIsAvailableChanged(winrt::Windows::Foundation::IInspectable, winrt::Windows::Foundation::IInspectable)
{
    ...
    if (m_spatialLocator != spatialLocator)
    {
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken = m_spatialLocator.LocatabilityChanged(std::bind(&HL_MVCE_SpatialSurfaceMeshUpdateProblemMain::OnLocatabilityChanged, this, _1, _2));
            ...
            auto PerceptionAccessStatusTask{ CheckSpatialPerceptionAccessStatusAsync() };
            if (PerceptionAccessStatusTask.get() == true)
            {
                m_mapping = std::make_unique<SpatialMapping>(m_stationaryReferenceFrame.CoordinateSystem());
            }
